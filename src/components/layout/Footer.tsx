              ...
              <ul className="space-y-3">
                {NAV_LINKS.map((link) => (
                  <li key={link.id}>
                    ...
                    >
                      <div className="h-1.5 w-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hover:w-2 transition-all duration-300" />
              ...
              <div className="flex flex-wrap gap-3">
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      <Icon className="h-5 w-5 text-white/60 group-hover:text-primary transition-colors duration-300" />
