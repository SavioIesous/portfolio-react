...
const About = () => {
  const skills = [
    ...
    { name: "Typescript", icon: SiTypescript, color: "#3178cC6" },
    { name: "Tailwindcss", icon: SiTailwindcss, color: "#06B6B4" },
              ...
              <div className="grid grid-cols-3 gap-8">
                {ABOUT_STATS.map((stat, index) => (
                  <div key={index} className="relative">
                    <div className="absolute -left-4 top-0 w-1 h-full bg-linear-to-b from-primary via-primary/50 to-primary/25 rounded-full"></div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  ...
                  <h3 className="text-base font-semibold text-white mb-2">Perfomace</h3>
                  <p className="text-sm text-white/70 leading-relaxed">Description</p>
                </div>
              </div>
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="grid grid-cols-3 gap-6 text-center">
                    <div>
                      ...
                      <div className="text-xs text-white/60">Client Satsfact</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-primary mb-1">24/7</div>
                      <div className="text-xs text-white/60">Support Availble</div>
                    </div>
                    <div>
        ...
        <FadeIn delay={500}>
                <div className="flex flex-col items-center gap-8">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-white/60">technologies I work with to build amazing product</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
                    {skills.map((skill, index) => (
                      <div
                      key={index}
                      className="group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:text-primary/50 rounded-2xl p-6 flex flex-col items-center justify-center gap-3 transition-all duration-300 hover:scale-105"
                      >
