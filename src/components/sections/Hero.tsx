...
import projetoImg from "../../../public/images/projects/programming.jpeg"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-2.5 px-[18px] py-[11px] mb-8 bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border-primary/20 rounded-full">
            ...
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                Buildin modern, scalable web application with React, Typescript,
                and cutting-edge technologies. Transforming ideas into
          ...
          <FadeIn delay={200}>
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl aspect-12/9 max-w-[500px] ml-auto group">
                ...
                {/* Image container */}
                <div className="relative rounded-2xl overflow-hidden m-[2px] h-[calc(100%-2)] ">
                  <img
                    src={projetoImg}
                    alt="Me programming"
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  <FadeIn delay={500}>
                    <div className="flex items-center gap-4 bg-black/50 backdrop-blur-sm border border-white/10 rounded-full px-6 py-3">
                      <div className="w-6 h-6 flex items-center justify-center hover:scale-110 transition-transform duration-200">
