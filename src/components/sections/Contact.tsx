...
const Contact: React.FC = () => {
  ...
  const handleChange = (
    ...
    setFormData(
      (prev) => ({ ...(prev as ContactForm), [name]: value }) as ContactForm,
    );
  };
  ...
  // tipagem simples para os ícones sociais
  ...
  return (
    <section id="contact" className="relative py-20 bg-black overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary/10 opacity-30 rounded-full blur-3xl" />
      </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  {Object.entries(SOCIAL_LINKS)
                    ...
                    .map(([platform, url]) => {
                      const Icon = (
                        socialIcons as Record<string, React.ElementType>
                      )[platform];
                      return Icon ? (
                        <a
                          key={platform}
